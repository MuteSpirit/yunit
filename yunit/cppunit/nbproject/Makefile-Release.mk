...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk ../../_bin/libcppunit.so
...
${OBJECTDIR}/_ext/1472/thunk.o: nbproject/Makefile-${CND_CONF}.mk ../thunk.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I../.. -I/usr/include -I/usr/include/c++/4.5.1 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/thunk.o ../thunk.cpp

${OBJECTDIR}/_ext/1472/test.o: nbproject/Makefile-${CND_CONF}.mk ../test.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I../.. -I/usr/include -I/usr/include/c++/4.5.1 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/test.o ../test.cpp

${OBJECTDIR}/_ext/1472/ltest.o: nbproject/Makefile-${CND_CONF}.mk ../ltest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1472
	${RM} $@.d
	$(COMPILE.cc) -O2 -Wall -I../.. -I/usr/include -I/usr/include/c++/4.5.1 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/ltest.o ../ltest.cpp

# Subprojects
.build-subprojects:
	cd ../../lua/lua51lib && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../../lua/lua51lib && ${MAKE}  -f Makefile CONF=Release clean
