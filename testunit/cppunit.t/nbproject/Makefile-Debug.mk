...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk ../../_bin/libcppunit.t.so
...
${OBJECTDIR}/_ext/1472/test.t.o: ../test.t.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1472/test.t.o ../test.t.cpp

# Subprojects
.build-subprojects:
	cd ../cppunit && ${MAKE}  -f Makefile CONF=Debug
...
# Subprojects
.clean-subprojects:
	cd ../cppunit && ${MAKE}  -f Makefile CONF=Debug clean
